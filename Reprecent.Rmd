...
```{r}
tmp <- read.xlsx2('data/SeriesReport-20170502035518_8b7173.xlsx',sheetIndex = 1,startRow = 12,endRow = 17,stringsAsFactors=FALSE)[-1,]
tmp2 <- tmp %>% melt("Year") 
ts.plot((as.numeric(tmp2$value[order(tmp2$Year)])-mean(as.numeric(tmp2$value)))/sd(as.numeric(tmp2$value)))
...
ts.plot((as.numeric(tmp2$value[order(tmp2$Year)]))/sd(as.numeric(tmp2$value)))
