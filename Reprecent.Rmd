...
Unem_diff<-c(0,diff(Unem$value))
Unem<-transform(Unem,Unem_diff = Unem_diff)
Unem_factor <- c()
for(i in 1:(length(Unem$Unem_diff)-11)){
  Unem_factor <- c(Unem_factor,sum(Unem$Unem_diff[i:(i+11)]))
}
Unem_factor <- c(rep(0,11),Unem_factor/sd(Unem_factor))
Unem <- transform(Unem,Unem_factor=Unem_factor)

ggplot(Unem,aes(x=date,y=Unem_factor))+geom_line()
